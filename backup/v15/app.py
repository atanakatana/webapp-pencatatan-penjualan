...
def update_supplier(supplier_id):
    ...
    try:
        ...
        # 2. PERBAIKAN: Kembalikan logika proses produk
...
def submit_catatan_harian():
    ...
    try:
        ...
        new_report = LaporanHarian(
            ...
            total_keuntungan=0, # Inisialisasi
        ...
        for prod_data in data.get('products', []):
            ...
            keuntungan_produk = total_harga_jual - total_harga_beli # Hitung keuntungan per produk

            rincian = LaporanHarianProduk(
                laporan_id=new_report.id, product_id=product.id, stok_awal=stok_awal, 
                stok_akhir=stok_akhir, jumlah_terjual=jumlah_terjual, 
                total_harga_jual=total_harga_jual, total_harga_beli=total_harga_beli,
                keuntungan=keuntungan_produk # Simpan keuntungan
            )
            db.session.add(rincian)
            ...
            total_keuntungan_auto += keuntungan_produk # Akumulasi total keuntungan
        ...
        new_report.total_keuntungan = total_keuntungan_auto # Simpan total keuntungan
